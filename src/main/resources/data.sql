...
INSERT INTO USUARIOS (USERNAME, PASSWORD_HASH, ROL, ENABLED, ACCOUNT_NON_EXPIRED, ACCOUNT_NON_LOCKED, CREDENTIALS_NON_EXPIRED) VALUES
    ('admin',      '$2a$10$DzKRNGXAgXEjJ10JFUBAcepzN3hh.BXfYWC5/oiC/rcYL2Ml7Y3IG', 'COORDINADOR',          TRUE, TRUE, TRUE, TRUE),
    ('coordinador','$2a$10$DzKRNGXAgXEjJ10JFUBAcepzN3hh.BXfYWC5/oiC/rcYL2Ml7Y3IG', 'COORDINADOR',         TRUE, TRUE, TRUE, TRUE),
    ...
    ('evaluador',  '$2a$10$DzKRNGXAgXEjJ10JFUBAcepzN3hh.BXfYWC5/oiC/rcYL2Ml7Y3IG', 'EVALUADOR_EXTERNO',    TRUE, TRUE, TRUE, TRUE),
    ('COORDINADOR','$2a$10$DzKRNGXAgXEjJ10JFUBAcepzN3hh.BXfYWC5/oiC/rcYL2Ml7Y3IG', 'COORDINADOR',         TRUE, TRUE, TRUE, TRUE);

-- 2) Sample rubrics (simplified without ID_RA_ASIGNATURA)
INSERT INTO RUBRICAS (NOMBRE, DESCRIPCION, FECHA_CREACION, ESTADO) VALUES
    ('Rúbrica para Patrones de Diseño', 'Evaluación de la aplicación de patrones de diseño en proyectos de software', '2024-05-15', 'ACTIVO'),
    ('Rúbrica para Pruebas Unitarias', 'Evaluación de la implementación de pruebas unitarias en proyectos de software', '2024-05-20', 'ACTIVO'),
    ('Rúbrica para Metodologías Ágiles', 'Evaluación de la aplicación de metodologías ágiles en proyectos', '2024-05-25', 'ACTIVO'),
...
INSERT INTO CRITERIOS (NOMBRE, DESCRIPCION, PESO, RUBRICA_ID) VALUES
    ('Selección de patrones', 'Correcta selección e implementación de patrones de diseño adecuados al problema', 30.00, 1),
...
INSERT INTO NIVELES_DESEMPENO (DESCRIPCION, PUNTAJE, CRITERIO_ID) VALUES
